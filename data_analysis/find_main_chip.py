...
VID_DIR = 'april3_microphoneBoardE_0'
...
if __name__ == "__main__":
    ...
    jpg1 = load_images(f'{VID_DIR}/preview', 'frame_{:06d}.jpg', read_flag=cv2.IMREAD_GRAYSCALE)

    avg1 = average_image(jpg1, lambda img: is_valid(img, 29))

    corners = find_center_chip(avg1)

    rightmost = np.array(corners[3])

    with open(f'{VID_DIR}/alignment.txt', 'w') as file:
